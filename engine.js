// engine.js - Website editor with text editing, color picker, image upload, and button creation
...
function clearSelection() {
  ...
  if (selectedWrapper) {
    selectedWrapper.querySelectorAll(".onkaan-resizable").forEach(h => h.remove());
  }
  selectedElement = null;
  selectedWrapper = null;
}
